...
<div class="main-width">
	...
	<div class="left" style="width:228px;height:224px;padding:8px 6px;background:url(images/dl2.png);">
		...
		<div class="right"><img src="images/1_r7_c15.png"/></div>
		<div class="clear"></div>
		<div style="padding:12px;">
			<table>
			<tr>
			<td style="width:50px;height:40px;text-align:right;font-size:14px;">用户名</td>
			<td><input type="text" name="username" style="width:120px;height:21px;"/></td>
			</tr>
			<tr>
			<td style="width:50px;height:40px;text-align:right;font-size:14px;">密&nbsp;&nbsp;&nbsp;码</td>
			<td><input type="password" name="password" style="width:120px;height:21px;"/></td>
			</tr>
			<tr>
			...
			<td><input type="image" src="images/1_r9_c14.png"/></td>
			</tr>
			</table>
		</div>
	</div>
...
<div class="main-width" style="margin-top:10px;margin-bottom:10px;">
	...
	<div class="right">
		<div style="margin:4px;">
			...
			<div class="clear"></div>
			<div style="margin:5px 0px;"><img src="images/tw2.png"/></div>
		</div>
