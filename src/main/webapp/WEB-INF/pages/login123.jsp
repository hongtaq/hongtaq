...
<div style="float:left; height:520px; width:410px; border-width:2px 1px 1px 1px;border-color:#cdcdcd;border-style:solid;border-radius:4px; margin:10px auto;"> <div class="box gradient">
          ...
          <div class="content ">
            <form class="bs-docs-example form-horizontal" action="j_spring_security_check" method="post">
              ...
              <div class="control-group row-fluid">
                ...
                <div class="controls span5 input-append">
                  <input type="password" id="inputUsername"  name="j_username" placeholder="用户名" class="row-fluid"><span class="add-on"><i class="icon-user"></i></span>
                </div>
              </div>
              <div class="control-group row-fluid">
                <label class="control-label span4" for="inputPassword" style="color:#000; font-size:18px; font-weight:bold;">密&nbsp;&nbsp;&nbsp;码</label>
                <div class="controls span5 input-append">
                  <input type="password" id="inputPassword"  name="j_password" placeholder="密码" class="row-fluid"><span class="add-on"><i class="icon-lock"></i></span>
                </div>
              </div>
              <!--  <div class="control-group row-fluid">
