...
<body>
	<div class="main_header">
		...
		<div class="header_right">
			...
			<a href="javascript:logout();"><img src="${ctx}/images/out.gif" border="0"/></a>
		</div>
	</div>
	<div class="main_content">
		...
		<div class="content_right">
			<table cellspacing="0" cellpadding="0">
				<tr style="height:29px;background: url('${ctx}/images/content-bg.gif') repeat-x;">
					<td style="height:29px;width:17px;background: url('${ctx}/images/left-top-right.gif') no-repeat;"></td>
					<td style="height:29px;line-height:29px;"><div class="content_title">首页</div></td>
					<td style="height:29px;width:16px;background: url('${ctx}/images/nav-right-bg.gif') no-repeat;"></td>
				</tr>
				<tr>
					<td style="background:url('${ctx}/images/mail_leftbg.gif') repeat-y;"></td>
					...
					<td style="background:url('${ctx}/images/mail_rightbg.gif') repeat-y;"></td>
				</tr>
				<tr style="background: url('${ctx}/images/buttom_bgs.gif') repeat-x;">
					<td style="height:17px;background: url('${ctx}/images/buttom_left2.gif') no-repeat;"></td>
					<td></td>
					<td style="height:17px;background: url('${ctx}/images/buttom_right2.gif') no-repeat;"></td>
				</tr>
			</table>
...
$(document).ready(function(){
	...
	$(".menu_line a").bind("click",function(){
		...
		//$("#mainFrame").attr("src","");
		$(".menu_line a").css("background-image","url('${ctx}/images/menu_bg1.gif')");
		$(".menu_line a").css("color","#333333");
		$(".menu_line a").css("font-weight","normal");
		$(".menu_line a").bind({
			mouseover:function(){
				$(this).css("background-image","url('${ctx}/images/menu_bg2.gif')");
				$(this).css("color","#006600");
				$(this).css("font-weight","bold");
			},
			mouseout:function(){
				$(this).css("background-image","url('${ctx}/images/menu_bg1.gif')");
