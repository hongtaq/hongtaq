...
<link type="text/css" rel="stylesheet" href="${ctx}/js/zTree/zTreeStyle.css"/>
</head>
<body>
	<div>
	...
	<script type="text/javascript" src="${ctx}/js/zTree/jquery.ztree-2.6.min.js"></script>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			dg.addBtn('ok','保存',function(){
				...
				var postData;
				if(username!=""){
					postData = {"username":username,"menuIds":ids};
				}else{
