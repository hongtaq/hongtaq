...
<link href="lib/bootstrap/css/bootstrap-responsive.min.css" type="text/css" rel="stylesheet"/>
...
<div style="height:25px;background:#f4f4f4;border-bottom:1px solid #eee;">
  <div class="main-width" style="padding-top:4px;text-align:right;font-size:12px;color:#555;"><span style="color:#F90">欢迎您</span>：wade1988
             ...
             | <a href="login.jsp" class="small-blue">退出</a> |
             
    </div>
</div>
<div class="main-width" style="height:91px;">
  <div class="left" style="padding:15px 2px;"><a href="index.jsp"><img src="images/logo.png"/></a></div>
...
<div style=" font-size:18px; font-weight:bold; padding:0px 0px 0px 16px; line-height:65px"
>会员信息管理</div>
...
<div  style=" height:50px; margin:0px 0px 10px 0px;"> 
 <div style=" float:left; font-size:15px; color:#000; font-weight:bold; padding:20px 0px 3px 12px;">登录密码修改</div> 

<div style="float:right;font-size:15px; color:#0066cc; font-weight:bold; padding:20px 12px 3px 0px;"> <a href="userinfo.jsp">返回个人信息</a></div></div>
<hr />
...
<div class="box gradient">
          ...
          <div class="content ">
            <form class="bs-docs-example form-horizontal"  id="chPasswdForm">
              <div class="control-group row-fluid">
                <label class="control-label span4" for="inputPassword">当前登录密码</label>
                <div class="controls span5 input-append">
                  <input type="password" id="inputPassword1" placeholder="请输入老密码" class="row-fluid" name="oldpassword" ><span class="add-on"><i class="icon-lock" ></i></span>
                </div>
              </div>
              <div class="control-group row-fluid">
                <label class="control-label span4" for="inputPassword">设置新密码</label>
                <div class="controls span5 input-append">
                  <input type="password" id="inputPassword2" placeholder="设置新密码" class="row-fluid" name="password"><span class="add-on"><i class="icon-lock"></i></span>
                </div>
              </div>
              <div class="control-group row-fluid">
                <label class="control-label span4" for="inputPassword">确认新密码</label>
                <div class="controls span5 input-append">
